...
public class VisitorSurnameListAdapter extends ArrayAdapter<NameListDataModel> {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            if (constraint == null || constraint.length() == 0) {
                ...
                for (NameListDataModel arrItem : arrayListFull) {
                    ...
                    String surname = arrNameList.length > 0 ? arrNameList[1] : arrItem.getName();
    ...
    public VisitorSurnameListAdapter(@NonNull Context context, List<NameListDataModel> arrayList) {
